...
ZorkUL::ZorkUL() : weapon(new Weapon("blaster", 20)), rooms{
  ...
  Room("Forest"), 		Room("Small Mountain"), 				Room("Small Mountain"), Room("Plains"), 		Room("Forest"), Room("Mountain"), 			Room("Mountain"),
...
void ZorkUL::resetGame() {
    ...
    rooms[9].addItem(new Item("rope"));     // b6
    rooms[9].addItem(new Item("planks"));   // b6
    rooms[29].addItem(new Item("sail"));    // e5
